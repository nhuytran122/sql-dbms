-- 1. Thực hiện các yêu cầu thống kê dữ liệu sau đây, sử dụng 2 cách làm:
-- Cách 1: Sử dụng biến bảng (hoặc bảng tạm)
...
BEGIN
    INSERT INTO #doanhThuNam (Nam, DoanhThu)
    SELECT @tmpYear AS Nam, ISNULL(SUM(Quantity * SalePrice), 0) AS DoanhThu
